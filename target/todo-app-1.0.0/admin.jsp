                ...
                <div class="table-wrapper">
                    ...
                    <div class="clearfix">
                        ...
                        <ul class="pagination">
                            <c:if test="${tag > 1}">
                                <li class="page-item">
                                    <a href="./load-data?page=${tag - 1}" class="page-link">Previous</a>
                                </li>
                            </c:if>
                            <c:forEach begin="${(tag - 5) < 1 ? 1 : (tag - 5)}" end="${(tag + 5) > endP ? endP : (tag + 5)}" var="i">
                                <li class="page-item ${tag == i ? 'active' : ''}">
                                    <a href="./load-data?page=${i}" class="page-link" style="text-decoration: none;">${i}</a>
                                </li>
                            </c:forEach>
                            <c:if test="${tag < endP}">
                                <li class="page-item">
                                    <a href="./load-data?page=${tag + 1}" class="page-link">Next</a>
                                </li>
                            </c:if>
                        </ul>
                    </div>
